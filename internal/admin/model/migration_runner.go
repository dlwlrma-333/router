...
func runMainVersionedMigrations(db *gorm.DB) error {
	migrations := []versionedMigration{
		{
			Version:     "202603091530_main_baseline_v8",
			Description: "baseline: create current main schema, sync channel model types, migrate redemption code column, and seed current catalogs",
			Up: func(tx *gorm.DB) error {
